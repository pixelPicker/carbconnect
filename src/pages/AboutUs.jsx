  ...
  return (
    <div className="min-h-screen bg-green-100 !py-12 !px-6 sm:!px-8 lg:!px-12 text-gray-900">
      <div className="max-w-6xl !mx-auto text-center">
        <h1 className="text-4xl font-Bricolage font-bold text-green-950 !mt-17 !mb-6">Meet Our Team</h1>
        <p className="text-xl !px-5 text-green-800 !mb-10">
          ...
          {teamMembers.map((member) => (
            ...
            >
              <img
                src={member.image}
                alt={member.name}
                className="w-32 h-32 !mx-auto rounded-full !mt-4 object-center object-cover !mb-4 border-4 border-green-500 shadow-sm"
              />
